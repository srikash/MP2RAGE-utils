...
elseif MP2RAGE.Coregister == 0
    ...
    spm_jobman('run', matlabbatch);
    %% Rename registered B1 map
    copyfile([MP2RAGE.filepathsa2rageB1map,'/rs_',MP2RAGE.filenamesa2rageB1map,MP2RAGE.extsa2rageB1map],[MP2RAGE.filepathsa2rageB1map,'/',MP2RAGE.filenamesa2rageB1map,'_resliced.nii']);
